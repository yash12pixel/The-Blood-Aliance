...
import com.example.thebloodaliance.activities.LoginActivity;
import com.example.thebloodaliance.activities.PostActivity;
import com.example.thebloodaliance.activities.ProfileActivity;
import com.example.thebloodaliance.R;
import com.example.thebloodaliance.activities.AboutUs;
import com.example.thebloodaliance.fragments.AchievmentsView;
import com.example.thebloodaliance.fragments.BloodInfo;
import com.example.thebloodaliance.fragments.HomeView;
import com.example.thebloodaliance.fragments.SearchDonorFragment;
import com.example.thebloodaliance.viewmodels.UserData;
...
//        getActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        singleuser.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                String name = snapshot.getValue(UserData.class).getName();
...
//        NavigationUI.setupWithNavController(navigationView, navController);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.home_view) {
          ...
          // getSupportFragmentManager().beginTransaction().replace(R.id.fragmentcontainer, new MapsActivity()).commit();
//            Intent intent = new Intent(getApplicationContext(), LoginActivity.class);
//            startActivity(intent);
            Intent intent = getPackageManager().getLaunchIntentForPackage("com.example.googlemapsactivity");
            startActivity(intent);
        }
